...
('Charlie', 'large', (SELECT user_id FROM Users WHERE username = 'isobel123')),
('Daisy', 'medium', (SELECT user_id FROM Users WHERE username = 'isobel123')),
('Rocky', 'large', (SELECT user_id FROM Users WHERE username = 'bobwalker'));
